...
public class TrainDTO {
	...
	@Pattern(regexp = "^[a-zA-Z\\s]*$", message = "Train name must contain only alphabets and spaces")
	...
	@Pattern(regexp = "^[a-zA-Z\\s]*$", message = "Source name must contain only alphabets and spaces")
	private String source;

	@NotBlank(message = "Destination is required")
	@Pattern(regexp = "^[a-zA-Z\\s]*$", message = "Destination name must contain only alphabets and spaces")
